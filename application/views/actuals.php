		...
		<div class="panel-body">
		    ...
		    <form class="form-horizontal" style="padding-bottom: 2em;" action="<?php echo base_url(); ?>rosta/actuals" method="post">
				...
				<div class="control-group">
					...
					<input type="hidden" id="month" value="<?php  ?>">
...
<option value="12">DECEMBER</option>
			...
			<div class="col-md-3">
				...
				<div class="control-group">
						...
						<input type="hidden" id="year" value="<?php  ?>">
...
//
		...
		<input type="text" style="text-transform:uppercase; padding:0px; text-align: center;" class="actual field" did="<?php echo $ddate; ?>"  day="<?php echo $i; ?>" maxlength="1" size="1px" title="P,R,X and L only" 
...
if(letter!==""){
//check if letter is a valid scheduleo;

letter=letter.replace(/\s/g, '');//remove spaces

letter=letter.toUpperCase();//converte to upper case

if(letter!=="P" && letter!=="R" && letter!=="L" && letter!="X" ){  // if letter is not defined as atual tracker
