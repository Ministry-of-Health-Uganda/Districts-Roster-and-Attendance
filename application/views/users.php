    ...
    <!-- Main content -->
       ...
       <div class="nav-tabs-custom">
             <ul class="nav nav-tabs">
			      <li <?php if($url==$burl."admin/addUsers") { echo $activate;} ?>><a href="<?php echo base_url()?>admin/user_list">Add Users</a></li>
            <li <?php if($url==$burl."admin/user_list") { echo $activate;} ?>><a href="<?php echo base_url()?>admin/user_list">Manage Users</a></li>
            <li <?php if($url==$burl."admin/showLogs") { echo $activate;} ?>><a href="<?php echo base_url()?>admin/showLogs">User Logs</a></li>
