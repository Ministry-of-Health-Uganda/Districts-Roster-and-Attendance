...
echo "<font color='red'> No Usable Data</font>";
    	 ...
    	 if(!$thisdistrict){
    	     ...
    	     //if no district is specified, we append general to the heading
		 echo "<br><br> GENERAL"; 
		 
		}

?>
	MONTHLY COMPARATIVE  SUMMARY

		<?php
		
		 if($thisdistrict){
		 echo "<br>". Modules::run("districts/getDistrict",$thisdistrict)."<br>"; 
		 
		}
		
		if($thisfacility){
		 echo Modules::run("districts/getFacility",$thisfacility)."<br>"; 
...
<tr>
	...
	<td class="cost"><?php echo $sum['D']+$sum['E']+$sum['N'];?></td>
    <td class="cost"><?php echo $sum['OR'];?></td>
	<td class="cost"><?php echo $sum['M']+$sum['A']+$sum['S'];?></td>
	<td class="cost"><?php echo $sum['Z'];?></td>

	<td width="10%" class="cost"><?php echo $sum['P'];?></td>
	<td width="10%" class="cost"><?php echo $sum['O'];?></td>
	<td width="10%"  class="cost"><?php echo $sum['R'];?></td>
	<td width="10%" class="cost"><?php echo $sum['L'];?></td>
