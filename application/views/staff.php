  ...
  <div class="content-wrapper">
   ...
   <div class="nav-tabs-custom">
             <ul class="nav nav-tabs">
			      <li class=""><a href="<?php echo base_url()?>attendance">Dashboard</a></li>
			      <li class="active"><a href="<?php echo base_url()?>admin/user_list">My Staff</a></li>
   ...
   <!-- general form elements -->
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Heath Staff for -<?php echo $staffs[0]['facility']; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body" id='scheduletb'>
                <table class="table table-striped table-bordered thistbl">
                  ...
                  <tbody>
                    ...
                    <tr id="row<?php echo $staff['ihris_pid']; ?>" >

                     <td data-label="BIOMETRIC ID"><?php $stringfind="person|"; $replace=""; echo str_replace($stringfind,$replace, $staff['ihris_pid']);?></td> 
