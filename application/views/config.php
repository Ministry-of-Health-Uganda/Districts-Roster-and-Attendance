  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
       ...
       <div class="col-md-6">
            ...
            <div class="panel">
  <div class="panel-heading with-border"><h4><?php echo $title; ?></h4>
  <hr/>
...
//print_r($varss);
 ...
 if($var1['variable']=="Duty Rosta End Date"){
       ...
       <div class="form-group">
           ...
           <button class="btn btn-success" type="submit"><i class="ion ion-ios-albums"></i>Save Changes</button>
...
<!-- END COL-6-->
  ...
  <div class="panel-heading">
      <h4>Upload iHRIS Biometric Users Report</h4>
  <hr/>
  <span class="notif"><?php echo $this->session->flashdata('alert'); ?></span></div>
   ...
   <div class="panel-body">
       ...
       <div class="form-group">
         ...
         <button class="btn btn-success" type="submit" onclick="uploadStarted()"><i class="ion ion-ios-cloud-upload">Upload</i></button>
           
           </div>

</form>
<div class="panel-heading">
      <h4>Comparative Summary Report for IHRIS</h4>
  <hr/>
 </div>
<p>
          <li><a href="<?php echo base_url(); ?>rosta/fullSummary">Compartive Roster and Attendance Summary</a> </li>
          <li><a href="<?php echo base_url(); ?>rosta/SharedCsv1">Rosta Summary Pushed iHRIS</a> </li>
