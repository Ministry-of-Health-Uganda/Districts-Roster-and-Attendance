...
?>
        ...
        <li>
         ...
         <li><a href="<?php echo base_url(); ?>rosta/summary"><i class="fa fa-circle-o"></i>Duty Roster Sumamry</a></li>
         
         
         <li><a href="<?php echo base_url(); ?>rosta/actualsreport"><i class="fa fa-circle-o"></i>Daily Attendance Report</a></li>
         
          <li><a href="<?php echo base_url(); ?>rosta/attendance_summary"><i class="fa fa-circle-o"></i>Attendance Sumamry</a></li>
