...
$facility_id="facility|".$prefix.$machineData[4]; //Excel Column 4 ;
	 }
...
if($_FILES["estab_file"]["size"] > 0)  //check whether file has data
    {
...
$job_id=$machineData[3];
$job=$machineData[4];
$surname=$machineData[5];
$firstname=$machineData[6];
$salary=$machineData[7];
$facility_type_id=$machineData[8];
$facility_type=$machineData[9];
$facility_id=$machineData[10];
$facility=$machineData[11];
