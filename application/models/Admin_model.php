...
class Admin_model extends CI_Model {
 ...
 function list_scheduled($month=FALSE,$year=FALSE,$district=FALSE){
      ...
      if($district=="all"){
          ...
          $query=$this->db->query("select distinct(ihrisdata.facility),ihrisdata.district from duty_rosta,ihrisdata where duty_rosta.duty_date like '$date%' and duty_rosta.facility_id=ihrisdata.facility_id" );
          
      }
      
      else{
      
      $query=$this->db->query("select distinct ihrisdata.facility ,ihrisdata.district from ihrisdata,duty_rosta where duty_rosta.duty_date like '$date%' and ihrisdata.district_id='$district' and duty_rosta.facility_id=ihrisdata.facility_id");
    //  $this->db->select(ihrisdata.facility)
