...
class Jobs extends MX_Controller {
	...
	public function __Construct(){
		...
		$this->watermark=FCPATH."assets/img/watermark.png";
	...
	public function getJobs($district,$facility,$facility_type=FALSE)
	{
		...
		$jobs=$this->jobs_mdl->getJobs($district,$facility,$facility_type);
	...
	public function getJob($id)
	{
		...
		$job=$this->jobs_mdl->getJob("job|".$id);
	...
	public function getEstablishment($district=FALSE,$facility=FALSE,$job,$facility_type=FALSE){
		...
		$esta=$this->jobs_mdl->getEstablishment($district,$facility,$job,$facility_type);
   ...
   //<select   name='facility_id'>
		...
		public function showAttendance()
	{
		...
		$data['attendances']=$this->jobs_mdl->getAtt($district,$facility,$year,$month,$facility_type);

		$data['schedules']=$this->jobs_mdl->getSchedules();
	...
	public function sumAtt($schedule,$job_id,$year,$month,$district=FALSE,$facility=FALSE,$facility_type=FALSE){
		...
		$att=$this->jobs_mdl->sumAtt($schedule,$job_id,$facility,$district,$year,$month,urldecode($facility_type));
  ...
  public function printAttendance($year=FALSE,$month=FALSE,$district=FALSE,$facility=FALSE,$facility_type=FALSE)
	{
		...
		$data['attendances']=$this->jobs_mdl->getAtt($district,$facility,$year,$month,urldecode($facility_type));
